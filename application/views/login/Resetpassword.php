...
<head>
    ...
    <title>Set Password JAJANPULSA.ID</title>
    ...
    <link rel="shortcut icon" href="<?php echo base_url()?>assets/img/logo_icon1.png" type="image/x-icon">
            ...
            <div class="col-12">
                ...
                <div id="auth-left">
                    ...
                    <!-- <div class="auth-logo"> -->
                        ...
                        <a href="<?php echo base_url('dashboard')?>"><img style="height: 30%;width: 30%;" src="<?php echo base_url()?>assets/img/Logo.png" alt="Logo"></a>
