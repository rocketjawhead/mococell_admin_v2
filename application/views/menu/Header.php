...
>
  <head>
    ...
    <title>Administrator Moco Cell</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">MOCO MOCO</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item <?php if($this->uri->segment(2) == 'Dashboard' || $this->uri->segment(2) == 'dashboard'){ echo 'active';}else{echo '';}?>">
              <a href="<?php echo base_url('agent/Dashboard/');?>" class="menu-link">
            ...
            <li class="menu-item <?php if($this->uri->segment(2) == 'Pending' || $this->uri->segment(2) == 'pending'){ echo 'active';}else{echo '';}?>">
              <a href="<?php echo base_url('agent/Pending/');?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
