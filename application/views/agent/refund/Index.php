...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaction /</span> Refund</h4>
      ...
      <table class="table table-striped">
        ...
        foreach($json_decoded as $row){ ?>
          <tr>
            ...
            <td><span class="<?php echo $row->refund_badge;?>"><?php echo $row->is_refund_desc;?></span></td>
          </tr>
        <?php }?>
        </tbody>
      </table>
