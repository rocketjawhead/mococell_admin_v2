              ...
              <table class="table table-bordered" id="" width="100%" cellspacing="0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <input type="text" class="form-control title_blog" id="title_blog" value="<?php echo $title_blog;?>">    
                    </td>
                  </tr>
                  <tr>
                    <td><b>Desc Post</b></td>
                    ...
                    <td>
                      <div class="form-group">
                        <select class="form-control category" id="category">
                          <option value="<?php echo $id_category;?>">Selected Data : <?php echo $category;?></option>
                  ...
                  <tr>
                    <td><b>Meta</b></td>
                    <td>
                      <input type="text" class="form-control alt_img" id="alt_img" placeholder="Alt Img" value="<?php echo $alt_img;?>"><br/>
                      <input type="text" class="form-control meta_title" id="meta_title" placeholder="Meta Title" value="<?php echo $meta_title;?>"><br/>
                      <input type="text" class="form-control meta_desc" id="meta_desc" placeholder="Meta Desc" value="<?php echo $meta_desc;?>"><br/>
                      <input type="text" class="form-control meta_robot" id="meta_robot" placeholder="Meta Robot" value="<?php echo $meta_robot;?>"><br/>   
                    </td>
                  </tr>
                  <tr>
                    <td><b>URL Link</b></td>
                    <td>
                      <input type="text" class="form-control urldownload" id="urldownload" value="<?php echo $urldownload;?>">    
                    </td>
                  </tr>
                  <tr>
                    <td><b>Image</b></td>
                    <td>
                      ...
                      <img id="dataimage" style="height: 200px;width: 75px;" src="<?php echo $imageurl;?>"/>
                    </td>
                  </tr>
                  <tr>
                    <td><b>Status</b></td>
                    <td>
                      <div class="form-group">
                        <select class="form-control status" id="status">
                          <option value="<?php echo $id_status;?>">Selected Data : <?php echo $status;?></option>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-check form-switch mb-2">
                        <input class="form-check-input is_stop" type="checkbox" id="is_stop" <?php echo $id_is_stop;?> />
                        <label class="form-check-label" for="flexSwitchCheckChecked"
                          >is Top</label
                        >
                      </div>
                      <div class="form-group">
                        <button class="btn btn-primary btn-sm btn-block" onClick="update_post();">Update Post</button>
    ...
    function update_post(){
          ...
          $.ajax({
              ...
              success: function (data) {
                ...
                //start
                $.ajax({
                  url : "<?php echo base_url();?>agent/blog/updateblog",
                  method : "POST",
                  data : {
                    id : id,
